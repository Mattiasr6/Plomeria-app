...
This project is indexed by GitNexus as **Plomeria-app** (227 symbols, 283 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Plomeria-app/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Plomeria-app/clusters` | All functional areas |
| `gitnexus://repo/Plomeria-app/processes` | All execution flows |
| `gitnexus://repo/Plomeria-app/process/{name}` | Step-by-step execution trace |
...
# AGENTS.md — Constitución del Sistema Plomeria-app
